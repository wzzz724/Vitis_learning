    ...
    function [320:0] proc_path(input [PROC_NUM - 1:0] dl_vec);
        ...
        begin
            ...
            case (index)
                ...
                2 : begin
                    proc_path = "krnl_vadd_krnl_vadd.load_input_1_U0";
                end
                3 : begin
        ...
        begin
            ...
            case (index1)
                0 : begin
                    ...
                    2: begin
                        if (ap_sync_entry_proc_U0_ap_ready & entry_proc_U0.ap_idle & ~ap_sync_load_input_1_U0_ap_ready) begin
                            $display("//      Blocked by input sync logic with process : 'krnl_vadd_krnl_vadd.load_input_1_U0'");
                        end
                    end
                    endcase
                end
                1 : begin
                    case(index2)
                    3: begin
                        if (~load_input_U0.size_c11_blk_n) begin
                            if (~size_c11_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'krnl_vadd_krnl_vadd.size_c11_U' written by process 'krnl_vadd_krnl_vadd.compute_add_U0'");
                                $fdisplay(fp, "Dependence_Channel_path krnl_vadd_krnl_vadd.size_c11_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~size_c11_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'krnl_vadd_krnl_vadd.size_c11_U' read by process 'krnl_vadd_krnl_vadd.compute_add_U0'");
                                $fdisplay(fp, "Dependence_Channel_path krnl_vadd_krnl_vadd.size_c11_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                    ...
                    3: begin
                        if (~load_input_1_U0.grp_load_input_1_Pipeline_mem_rd_fu_64.in2_stream_blk_n) begin
                            if (~in2_stream_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'krnl_vadd_krnl_vadd.in2_stream_U' written by process 'krnl_vadd_krnl_vadd.compute_add_U0'");
                                $fdisplay(fp, "Dependence_Channel_path krnl_vadd_krnl_vadd.in2_stream_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~in2_stream_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'krnl_vadd_krnl_vadd.in2_stream_U' read by process 'krnl_vadd_krnl_vadd.compute_add_U0'");
                                $fdisplay(fp, "Dependence_Channel_path krnl_vadd_krnl_vadd.in2_stream_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                ...
                3 : begin
                    ...
                    1: begin
                        if (~compute_add_U0.size_blk_n) begin
                            if (~size_c11_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'krnl_vadd_krnl_vadd.size_c11_U' written by process 'krnl_vadd_krnl_vadd.load_input_U0'");
                                $fdisplay(fp, "Dependence_Channel_path krnl_vadd_krnl_vadd.size_c11_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~size_c11_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'krnl_vadd_krnl_vadd.size_c11_U' read by process 'krnl_vadd_krnl_vadd.load_input_U0'");
                                $fdisplay(fp, "Dependence_Channel_path krnl_vadd_krnl_vadd.size_c11_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                        if (~compute_add_U0.grp_compute_add_Pipeline_execute_fu_52.in1_stream_blk_n) begin
                            if (~in1_stream_U.if_empty_n) begin
                    ...
                    4: begin
                        if (~compute_add_U0.size_c_blk_n) begin
                            if (~size_c_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'krnl_vadd_krnl_vadd.size_c_U' written by process 'krnl_vadd_krnl_vadd.store_result_U0'");
                                $fdisplay(fp, "Dependence_Channel_path krnl_vadd_krnl_vadd.size_c_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~size_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'krnl_vadd_krnl_vadd.size_c_U' read by process 'krnl_vadd_krnl_vadd.store_result_U0'");
                                $fdisplay(fp, "Dependence_Channel_path krnl_vadd_krnl_vadd.size_c_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                        if (~compute_add_U0.grp_compute_add_Pipeline_execute_fu_52.out_stream_blk_n) begin
                    ...
                    2: begin
                        if (~compute_add_U0.grp_compute_add_Pipeline_execute_fu_52.in2_stream_blk_n) begin
                            if (~in2_stream_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'krnl_vadd_krnl_vadd.in2_stream_U' written by process 'krnl_vadd_krnl_vadd.load_input_1_U0'");
                                $fdisplay(fp, "Dependence_Channel_path krnl_vadd_krnl_vadd.in2_stream_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~in2_stream_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'krnl_vadd_krnl_vadd.in2_stream_U' read by process 'krnl_vadd_krnl_vadd.load_input_1_U0'");
                                $fdisplay(fp, "Dependence_Channel_path krnl_vadd_krnl_vadd.in2_stream_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                ...
                4 : begin
                    ...
                    3: begin
                        if (~store_result_U0.size_blk_n) begin
                            if (~size_c_U.if_empty_n) begin
                        ...
                        if (~store_result_U0.grp_store_result_Pipeline_mem_wr_fu_73.out_stream_blk_n) begin
                            if (~out_stream_U.if_empty_n) begin
