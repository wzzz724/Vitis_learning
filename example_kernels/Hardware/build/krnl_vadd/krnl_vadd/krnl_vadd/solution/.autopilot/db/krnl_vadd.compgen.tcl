...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler krnl_vadd_fifo_w32_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {size_c11_U}
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler krnl_vadd_fifo_w32_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {in2_stream_U}
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler krnl_vadd_gmem1_m_axi BINDTYPE {interface} TYPE {adapter} IMPL {m_axi}
}
