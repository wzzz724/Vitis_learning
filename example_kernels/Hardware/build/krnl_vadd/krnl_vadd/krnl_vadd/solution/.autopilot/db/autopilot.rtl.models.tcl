set SynModuleInfo {
  ...
  {SRCNAME load_input.1_Pipeline_mem_rd MODELNAME load_input_1_Pipeline_mem_rd RTLNAME krnl_vadd_load_input_1_Pipeline_mem_rd}
  {SRCNAME load_input.1 MODELNAME load_input_1 RTLNAME krnl_vadd_load_input_1}
  {SRCNAME compute_add_Pipeline_execute MODELNAME compute_add_Pipeline_execute RTLNAME krnl_vadd_compute_add_Pipeline_execute}
  {SRCNAME compute_add MODELNAME compute_add RTLNAME krnl_vadd_compute_add}
  {SRCNAME store_result_Pipeline_mem_wr MODELNAME store_result_Pipeline_mem_wr RTLNAME krnl_vadd_store_result_Pipeline_mem_wr}
  ...
  {SRCNAME krnl_vadd MODELNAME krnl_vadd RTLNAME krnl_vadd IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME krnl_vadd_fifo_w32_d2_S RTLNAME krnl_vadd_fifo_w32_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME size_c11_U}
      ...
      {MODELNAME krnl_vadd_fifo_w32_d2_S RTLNAME krnl_vadd_fifo_w32_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME in2_stream_U}
