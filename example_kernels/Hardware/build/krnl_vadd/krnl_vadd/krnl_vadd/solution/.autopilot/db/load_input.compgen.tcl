...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_size_c11 \
    op interface \
    ports { size_c11_din { O 32 vector } size_c11_num_data_valid { I 2 vector } size_c11_fifo_cap { I 2 vector } size_c11_full_n { I 1 bit } size_c11_write { O 1 bit } } \
} "
}
