...
extern "C"
void krnl_vadd_hw_stub_wrapper(void*, void*, void*, hls::sim::Byte<4>);

extern "C"
void apatb_krnl_vadd_hw(void* __xlx_apatb_param_in1, void* __xlx_apatb_param_in2, void* __xlx_apatb_param_out_r, hls::sim::Byte<4> __xlx_apatb_param_size)
{
  ...
  port5.param = { __xlx_apatb_param_in2 };
  port5.depth = { 1 };
  port5.offset = {  };
  ...
  try {
    ...
    krnl_vadd_hw_stub_wrapper(__xlx_apatb_param_in1, __xlx_apatb_param_in2, __xlx_apatb_param_out_r, __xlx_apatb_param_size);
