...
architecture behav of krnl_vadd is 
    ...
    "krnl_vadd_krnl_vadd,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu280-fsvh2892-2L-e,HLS_INPUT_CLOCK=3.333000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.433090,HLS_SYN_LAT=4243,HLS_SYN_TPT=4172,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=3017,HLS_SYN_LUT=5424,HLS_VERSION=2022_2}";
...
attribute shreg_extract of ap_rst_n_inv : signal is "no";
    ...
    signal load_input_U0_size_c11_din : STD_LOGIC_VECTOR (31 downto 0);
    signal load_input_U0_size_c11_write : STD_LOGIC;
    ...
    signal compute_add_U0_size_c_din : STD_LOGIC_VECTOR (31 downto 0);
    signal compute_add_U0_size_c_write : STD_LOGIC;
    signal compute_add_U0_in1_stream_read : STD_LOGIC;
    signal compute_add_U0_in2_stream_read : STD_LOGIC;
    ...
    signal size_c11_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal size_c11_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    port (
        ...
        size_c11_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        size_c11_num_data_valid : IN STD_LOGIC_VECTOR (1 downto 0);
        size_c11_fifo_cap : IN STD_LOGIC_VECTOR (1 downto 0);
        size_c11_full_n : IN STD_LOGIC;
        size_c11_write : OUT STD_LOGIC;
    ...
    component krnl_vadd_load_input_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    port map (
        ...
        in_r => in1,
        size => size,
        size_c11_din => load_input_U0_size_c11_din,
        size_c11_num_data_valid => size_c11_num_data_valid,
        size_c11_fifo_cap => size_c11_fifo_cap,
        size_c11_full_n => size_c11_full_n,
        size_c11_write => load_input_U0_size_c11_write,
    ...
    load_input_1_U0 : component krnl_vadd_load_input_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    port map (
        ...
        size_num_data_valid => size_c11_num_data_valid,
        size_fifo_cap => size_c11_fifo_cap,
    ...
    size_c11_U : component krnl_vadd_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => load_input_U0_size_c11_din,
        if_full_n => size_c11_full_n,
        if_write => load_input_U0_size_c11_write,
        if_dout => size_c11_dout,
        if_num_data_valid => size_c11_num_data_valid,
        if_fifo_cap => size_c11_fifo_cap,
    ...
    in2_stream_U : component krnl_vadd_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ap_ext_blocking_sub_n <= (store_result_U0_ap_ext_blocking_n and load_input_U0_ap_ext_blocking_n and load_input_1_U0_ap_ext_blocking_n and entry_proc_U0_ap_ext_blocking_n and compute_add_U0_ap_ext_blocking_n);
    ap_idle <= (store_result_U0_ap_idle and load_input_U0_ap_idle and load_input_1_U0_ap_idle and entry_proc_U0_ap_idle and compute_add_U0_ap_idle);
    ap_int_blocking_cur_n <= ap_const_logic_1;
    ap_int_blocking_n <= (ap_int_blocking_sub_n and ap_int_blocking_cur_n);
    ap_int_blocking_sub_n <= (store_result_U0_ap_int_blocking_n and load_input_U0_ap_int_blocking_n and load_input_1_U0_ap_int_blocking_n and entry_proc_U0_ap_int_blocking_n and compute_add_U0_ap_int_blocking_n);
    ap_ready <= ap_sync_ready;
    ap_str_blocking_cur_n <= ap_const_logic_1;
    ap_str_blocking_n <= (ap_str_blocking_sub_n and ap_str_blocking_cur_n);
    ap_str_blocking_sub_n <= (store_result_U0_ap_str_blocking_n and load_input_U0_ap_str_blocking_n and load_input_1_U0_ap_str_blocking_n and entry_proc_U0_ap_str_blocking_n and compute_add_U0_ap_str_blocking_n);
