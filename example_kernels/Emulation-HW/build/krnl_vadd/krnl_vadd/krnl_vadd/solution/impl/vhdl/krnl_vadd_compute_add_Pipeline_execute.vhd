...
entity krnl_vadd_compute_add_Pipeline_execute is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of krnl_vadd_compute_add_Pipeline_execute is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln106_fu_83_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln108_fu_100_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln108_reg_117 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_fu_42 : STD_LOGIC_VECTOR (30 downto 0);
    signal i_1_fu_89_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_load : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal i_cast_fu_79_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln106_fu_83_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    add_ln108_fu_100_p2 <= std_logic_vector(unsigned(in2_stream_dout) + unsigned(in1_stream_dout));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln106_fu_83_p2)
    begin
        if (((icmp_ln106_fu_83_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    i_1_fu_89_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_load) + unsigned(ap_const_lv31_1));
    i_cast_fu_79_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_load),32));
    icmp_ln106_fu_83_p2 <= "1" when (signed(i_cast_fu_79_p1) < signed(size_load)) else "0";
    ...
    out_stream_din <= add_ln108_reg_117;
