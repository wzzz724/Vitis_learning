...
entity krnl_vadd_load_input_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of krnl_vadd_load_input_1 is 
...
attribute shreg_extract : string;
    ...
    signal trunc_ln_fu_92_p4 : STD_LOGIC_VECTOR (61 downto 0);
    signal trunc_ln_reg_127 : STD_LOGIC_VECTOR (61 downto 0);
    signal zext_ln93_fu_113_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal sext_ln93_fu_102_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    component krnl_vadd_load_input_1_Pipeline_mem_rd IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_load_input_1_Pipeline_mem_rd_fu_64 : component krnl_vadd_load_input_1_Pipeline_mem_rd
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                trunc_ln_reg_127 <= in_r(63 downto 2);
            end if;
        end if;
    end process;
    ...
    empty_29_fu_84_p3 <= 
        empty_fu_74_p1 when (icmp_ln93_fu_78_p2(0) = '1') else 
        ap_const_lv31_0;
    ...
    icmp_ln93_fu_78_p2 <= "1" when (signed(size) > signed(ap_const_lv32_0)) else "0";
    in2_stream_din <= grp_load_input_1_Pipeline_mem_rd_fu_64_in2_stream_din;
    ...
    m_axi_gmem1_ARADDR_assign_proc : process(m_axi_gmem1_ARREADY, ap_CS_fsm_state2, grp_load_input_1_Pipeline_mem_rd_fu_64_m_axi_gmem1_ARADDR, ap_CS_fsm_state72, ap_CS_fsm_state73, sext_ln93_fu_102_p1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem1_ARREADY = ap_const_logic_1))) then 
            m_axi_gmem1_ARADDR <= sext_ln93_fu_102_p1;
    ...
    m_axi_gmem1_ARLEN_assign_proc : process(m_axi_gmem1_ARREADY, ap_CS_fsm_state2, zext_ln93_fu_113_p1, grp_load_input_1_Pipeline_mem_rd_fu_64_m_axi_gmem1_ARLEN, ap_CS_fsm_state72, ap_CS_fsm_state73)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem1_ARREADY = ap_const_logic_1))) then 
            m_axi_gmem1_ARLEN <= zext_ln93_fu_113_p1;
        elsif (((ap_const_logic_1 = ap_CS_fsm_state73) or (ap_const_logic_1 = ap_CS_fsm_state72))) then 
            m_axi_gmem1_ARLEN <= grp_load_input_1_Pipeline_mem_rd_fu_64_m_axi_gmem1_ARLEN;
        else 
    ...
    m_axi_gmem1_WVALID <= ap_const_logic_0;
        sext_ln93_fu_102_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_fu_92_p4),64));

    trunc_ln_fu_92_p4 <= in_r(63 downto 2);
    zext_ln93_fu_113_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_29_reg_122),32));
end behav;
