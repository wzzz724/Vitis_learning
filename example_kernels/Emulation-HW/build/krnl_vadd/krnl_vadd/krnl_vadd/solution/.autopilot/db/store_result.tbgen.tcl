...
set portList { 
	...
	{ size_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ size_fifo_cap sc_in sc_lv 2 signal 2 } 
	{ size_empty_n sc_in sc_logic 1 signal 2 } 
	{ size_read sc_out sc_logic 1 signal 2 } 
	{ out_stream_dout sc_in sc_lv 32 signal 3 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_store_result_Pipeline_mem_wr_fu_73", "Port" : "gmem0", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			...
			{"Name" : "out_stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_store_result_Pipeline_mem_wr_fu_73", "Port" : "out_stream", "Inst_start_state" : "3", "Inst_end_state" : "4"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_store_result_Pipeline_mem_wr_fu_73", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_store_result_Pipeline_mem_wr_fu_73.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
