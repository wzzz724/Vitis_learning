; ModuleID = '/home/cnic/wz/workspace/example_kernels/Emulation-HW/build/krnl_vadd/krnl_vadd/krnl_vadd/solution/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_krnl_vadd_ir(i32* noalias nocapture nonnull readonly %in1, i32* noalias nocapture nonnull readonly %in2, i32* noalias nocapture nonnull %out, i32 %size) local_unnamed_addr #0 {
entry:
  %in1_copy = alloca i32, align 512
  %in2_copy = alloca i32, align 512
  %out_copy = alloca i32, align 512
  call fastcc void @copy_in(i32* nonnull %in1, i32* nonnull align 512 %in1_copy, i32* nonnull %in2, i32* nonnull align 512 %in2_copy, i32* nonnull %out, i32* nonnull align 512 %out_copy)
  call void @apatb_krnl_vadd_hw(i32* %in1_copy, i32* %in2_copy, i32* %out_copy, i32 %size)
  call void @copy_back(i32* %in1, i32* %in1_copy, i32* %in2, i32* %in2_copy, i32* %out, i32* %out_copy)
  ret void
}
...
declare void @apatb_krnl_vadd_hw(i32*, i32*, i32*, i32)
...
define void @krnl_vadd_hw_stub_wrapper(i32*, i32*, i32*, i32) #4 {
entry:
  call void @copy_out(i32* null, i32* %0, i32* null, i32* %1, i32* null, i32* %2)
  call void @krnl_vadd_hw_stub(i32* %0, i32* %1, i32* %2, i32 %3)
  call void @copy_in(i32* null, i32* %0, i32* null, i32* %1, i32* null, i32* %2)
  ret void
}

declare void @krnl_vadd_hw_stub(i32*, i32*, i32*, i32)
