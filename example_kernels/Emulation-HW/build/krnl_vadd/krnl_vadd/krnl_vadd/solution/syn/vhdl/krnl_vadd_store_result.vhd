...
attribute shreg_extract : string;
    ...
    signal size_read_reg_125 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln_reg_130 : STD_LOGIC_VECTOR (61 downto 0);
    signal empty_25_fu_103_p3 : STD_LOGIC_VECTOR (30 downto 0);
    signal empty_25_reg_136 : STD_LOGIC_VECTOR (30 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_ap_start : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_73_ap_done : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_73_ap_idle : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_73_ap_ready : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_73_out_stream_read : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWVALID : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_WVALID : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_WDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_WSTRB : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_WLAST : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_WID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_WUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_ARVALID : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_ARADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_ARID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_ARLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_ARSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_ARBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_ARLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_ARCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_ARPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_ARQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_ARREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_ARUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_RREADY : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_BREADY : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_73_ap_ext_blocking_n : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_73_ap_str_blocking_n : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_73_ap_int_blocking_n : STD_LOGIC;
    signal grp_store_result_Pipeline_mem_wr_fu_73_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal sext_ln114_fu_111_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln114_fu_121_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal icmp_ln114_fu_87_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component krnl_vadd_store_result_Pipeline_mem_wr IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_store_result_Pipeline_mem_wr_fu_73 : component krnl_vadd_store_result_Pipeline_mem_wr
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        sext_ln114 => trunc_ln_reg_130,
        size_load => size_read_reg_125,
        ap_ext_blocking_n => grp_store_result_Pipeline_mem_wr_fu_73_ap_ext_blocking_n,
        ap_str_blocking_n => grp_store_result_Pipeline_mem_wr_fu_73_ap_str_blocking_n,
        ap_int_blocking_n => grp_store_result_Pipeline_mem_wr_fu_73_ap_int_blocking_n);
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state72) and (m_axi_gmem0_BVALID = ap_const_logic_1))) then 
    ...
    grp_store_result_Pipeline_mem_wr_fu_73_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_store_result_Pipeline_mem_wr_fu_73_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
                    grp_store_result_Pipeline_mem_wr_fu_73_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_store_result_Pipeline_mem_wr_fu_73_ap_ready = ap_const_logic_1)) then 
                    grp_store_result_Pipeline_mem_wr_fu_73_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                empty_25_reg_136 <= empty_25_fu_103_p3;
                size_read_reg_125 <= size_dout;
                trunc_ln_reg_130 <= out_r_dout(63 downto 2);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem0_AWREADY, m_axi_gmem0_BVALID, out_r_empty_n, size_empty_n, ap_CS_fsm_state2, ap_CS_fsm_state72, grp_store_result_Pipeline_mem_wr_fu_73_ap_done, ap_CS_fsm_state4)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (size_empty_n = ap_const_logic_0) or (out_r_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
            ...
            when ap_ST_fsm_state4 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state4) and (grp_store_result_Pipeline_mem_wr_fu_73_ap_done = ap_const_logic_1))) then
    ...
    ap_ST_fsm_state1_blk_assign_proc : process(ap_start, ap_done_reg, out_r_empty_n, size_empty_n)
    begin
        if (((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (size_empty_n = ap_const_logic_0) or (out_r_empty_n = ap_const_logic_0))) then 
    ...
    ap_ST_fsm_state4_blk_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_ap_done)
    begin
        if ((grp_store_result_Pipeline_mem_wr_fu_73_ap_done = ap_const_logic_0)) then 
    ...
    begin
                ap_block_state1 <= ((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (size_empty_n = ap_const_logic_0) or (out_r_empty_n = ap_const_logic_0));
    end process;


    ap_done_assign_proc : process(ap_done_reg, m_axi_gmem0_BVALID, ap_CS_fsm_state72)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state72) and (m_axi_gmem0_BVALID = ap_const_logic_1))) then 
    ...
    ap_ext_blocking_cur_n <= (gmem0_blk_n_B and gmem0_blk_n_AW);
    ...
    ap_int_blocking_cur_n <= (size_blk_n and out_r_blk_n);
    ...
    ap_sub_ext_blocking_0_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_ap_ext_blocking_n)
    begin
        if ((grp_store_result_Pipeline_mem_wr_fu_73_ap_ext_blocking_n = ap_const_logic_0)) then 
    ...
    ap_sub_int_blocking_0_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_ap_int_blocking_n)
    begin
        if ((grp_store_result_Pipeline_mem_wr_fu_73_ap_int_blocking_n = ap_const_logic_0)) then 
    ...
    ap_sub_str_blocking_0_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_ap_str_blocking_n)
    begin
        if ((grp_store_result_Pipeline_mem_wr_fu_73_ap_str_blocking_n = ap_const_logic_0)) then 
    ...
    empty_25_fu_103_p3 <= 
        empty_fu_83_p1 when (icmp_ln114_fu_87_p2(0) = '1') else 
        ap_const_lv31_0;
    empty_fu_83_p1 <= size_dout(31 - 1 downto 0);
    ...
    grp_store_result_Pipeline_mem_wr_fu_73_ap_start <= grp_store_result_Pipeline_mem_wr_fu_73_ap_start_reg;
    icmp_ln114_fu_87_p2 <= "1" when (signed(size_dout) > signed(ap_const_lv32_0)) else "0";
    ...
    m_axi_gmem0_AWADDR_assign_proc : process(m_axi_gmem0_AWREADY, ap_CS_fsm_state2, grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWADDR, ap_CS_fsm_state3, ap_CS_fsm_state4, sext_ln114_fu_111_p1)
    begin
        if (((m_axi_gmem0_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem0_AWADDR <= sext_ln114_fu_111_p1;
    ...
    m_axi_gmem0_AWBURST_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWBURST, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
    ...
    m_axi_gmem0_AWCACHE_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWCACHE, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_AWCACHE <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWCACHE;
        else 
    ...
    m_axi_gmem0_AWID_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWID, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_AWID <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWID;
        else 
    ...
    m_axi_gmem0_AWLEN_assign_proc : process(m_axi_gmem0_AWREADY, ap_CS_fsm_state2, grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWLEN, ap_CS_fsm_state3, ap_CS_fsm_state4, zext_ln114_fu_121_p1)
    begin
        if (((m_axi_gmem0_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem0_AWLEN <= zext_ln114_fu_121_p1;
        elsif (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_AWLEN <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWLEN;
        else 
    ...
    m_axi_gmem0_AWLOCK_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWLOCK, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_AWLOCK <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWLOCK;
        else 
    ...
    m_axi_gmem0_AWPROT_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWPROT, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_AWPROT <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWPROT;
        else 
    ...
    m_axi_gmem0_AWQOS_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWQOS, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_AWQOS <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWQOS;
        else 
    ...
    m_axi_gmem0_AWREGION_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWREGION, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_AWREGION <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWREGION;
        else 
    ...
    m_axi_gmem0_AWSIZE_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWSIZE, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_AWSIZE <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWSIZE;
        else 
    ...
    m_axi_gmem0_AWUSER_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWUSER, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_AWUSER <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWUSER;
        else 
    ...
    m_axi_gmem0_AWVALID_assign_proc : process(m_axi_gmem0_AWREADY, ap_CS_fsm_state2, grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWVALID, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((m_axi_gmem0_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    m_axi_gmem0_BREADY_assign_proc : process(m_axi_gmem0_BVALID, ap_CS_fsm_state72, grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_BREADY, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state72) and (m_axi_gmem0_BVALID = ap_const_logic_1))) then 
    ...
    m_axi_gmem0_WVALID_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_WVALID, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_WVALID <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_WVALID;
        else 
    ...
    out_stream_read_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_out_stream_read, ap_CS_fsm_state4)
    begin
        ...
        sext_ln114_fu_111_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_reg_130),64));
    ...
    zext_ln114_fu_121_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_25_reg_136),32));
end behav;
