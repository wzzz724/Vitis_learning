...
wire   [30:0] empty_25_fu_103_p3;
reg   [30:0] empty_25_reg_136;
...
wire    grp_store_result_Pipeline_mem_wr_fu_73_ap_ext_blocking_n;
wire    grp_store_result_Pipeline_mem_wr_fu_73_ap_str_blocking_n;
wire    grp_store_result_Pipeline_mem_wr_fu_73_ap_int_blocking_n;
reg    grp_store_result_Pipeline_mem_wr_fu_73_ap_start_reg;
wire    ap_CS_fsm_state3;
wire    ap_CS_fsm_state4;
wire  signed [63:0] sext_ln114_fu_111_p1;
wire   [31:0] zext_ln114_fu_121_p1;
reg    ap_block_state1;
wire   [0:0] icmp_ln114_fu_87_p2;
...
krnl_vadd_store_result_Pipeline_mem_wr grp_store_result_Pipeline_mem_wr_fu_73(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (*) begin
    if ((grp_store_result_Pipeline_mem_wr_fu_73_ap_ext_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_store_result_Pipeline_mem_wr_fu_73_ap_int_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_store_result_Pipeline_mem_wr_fu_73_ap_str_blocking_n == 1'b0)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & (grp_store_result_Pipeline_mem_wr_fu_73_ap_done == 1'b1))) begin
...
assign ap_ext_blocking_cur_n = (gmem0_blk_n_B & gmem0_blk_n_AW);

assign ap_ext_blocking_n = (ap_ext_blocking_sub_n & ap_ext_blocking_cur_n);

assign ap_int_blocking_cur_n = (size_blk_n & out_r_blk_n);

assign ap_int_blocking_n = (ap_int_blocking_sub_n & ap_int_blocking_cur_n);

assign ap_str_blocking_n = (ap_str_blocking_sub_n & 1'b1);

assign empty_25_fu_103_p3 = ((icmp_ln114_fu_87_p2[0:0] == 1'b1) ? empty_fu_83_p1 : 31'd0);
...
assign icmp_ln114_fu_87_p2 = (($signed(size_dout) > $signed(32'd0)) ? 1'b1 : 1'b0);
...
assign sext_ln114_fu_111_p1 = $signed(trunc_ln_reg_130);

assign zext_ln114_fu_121_p1 = empty_25_reg_136;
