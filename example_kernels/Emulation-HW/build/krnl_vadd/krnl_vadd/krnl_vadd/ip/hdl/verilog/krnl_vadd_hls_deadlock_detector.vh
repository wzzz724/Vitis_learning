...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    krnl_vadd_hls_deadlock_detect_unit #(5, 0, 3, 3) krnl_vadd_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    krnl_vadd_hls_deadlock_detect_unit #(5, 1, 3, 3) krnl_vadd_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~load_input_U0.size_c11_blk_n) | (~load_input_U0.grp_load_input_Pipeline_mem_rd_fu_82.in1_stream_blk_n);
    ...
    krnl_vadd_hls_deadlock_detect_unit #(5, 2, 3, 3) krnl_vadd_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~load_input_1_U0.grp_load_input_1_Pipeline_mem_rd_fu_64.in2_stream_blk_n);
    ...
    krnl_vadd_hls_deadlock_detect_unit #(5, 3, 3, 3) krnl_vadd_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~compute_add_U0.size_blk_n) | (~compute_add_U0.grp_compute_add_Pipeline_execute_fu_52.in1_stream_blk_n);
    assign proc_3_data_PIPO_blk[0] = 1'b0;
    assign proc_3_start_FIFO_blk[0] = 1'b0 | (~start_for_compute_add_U0_U.if_empty_n & compute_add_U0.ap_idle & ~start_for_compute_add_U0_U.if_write);
    assign proc_3_TLF_FIFO_blk[0] = 1'b0;
    assign proc_3_input_sync_blk[0] = 1'b0;
    assign proc_3_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_3[0] = dl_detect_out ? proc_dep_vld_vec_3_reg[0] : (proc_3_data_FIFO_blk[0] | proc_3_data_PIPO_blk[0] | proc_3_start_FIFO_blk[0] | proc_3_TLF_FIFO_blk[0] | proc_3_input_sync_blk[0] | proc_3_output_sync_blk[0]);
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~compute_add_U0.size_c_blk_n) | (~compute_add_U0.grp_compute_add_Pipeline_execute_fu_52.out_stream_blk_n);
    ...
    assign proc_3_data_FIFO_blk[2] = 1'b0 | (~compute_add_U0.grp_compute_add_Pipeline_execute_fu_52.in2_stream_blk_n);
    ...
    krnl_vadd_hls_deadlock_detect_unit #(5, 4, 2, 2) krnl_vadd_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~store_result_U0.out_r_blk_n);
    assign proc_4_data_PIPO_blk[0] = 1'b0;
    assign proc_4_start_FIFO_blk[0] = 1'b0 | (~start_for_store_result_U0_U.if_empty_n & store_result_U0.ap_idle & ~start_for_store_result_U0_U.if_write);
    assign proc_4_TLF_FIFO_blk[0] = 1'b0;
    assign proc_4_input_sync_blk[0] = 1'b0;
    assign proc_4_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_4[0] = dl_detect_out ? proc_dep_vld_vec_4_reg[0] : (proc_4_data_FIFO_blk[0] | proc_4_data_PIPO_blk[0] | proc_4_start_FIFO_blk[0] | proc_4_TLF_FIFO_blk[0] | proc_4_input_sync_blk[0] | proc_4_output_sync_blk[0]);
    assign proc_4_data_FIFO_blk[1] = 1'b0 | (~store_result_U0.size_blk_n) | (~store_result_U0.grp_store_result_Pipeline_mem_wr_fu_73.out_stream_blk_n);
