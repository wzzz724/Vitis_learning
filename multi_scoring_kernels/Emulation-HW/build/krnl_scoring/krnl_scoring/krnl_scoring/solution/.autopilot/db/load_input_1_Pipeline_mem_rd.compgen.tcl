...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in2_stream_din { O 32 vector } in2_stream_num_data_valid { I 2 vector } in2_stream_fifo_cap { I 2 vector } in2_stream_full_n { I 1 bit } in2_stream_write { O 1 bit } } \
} "
}
