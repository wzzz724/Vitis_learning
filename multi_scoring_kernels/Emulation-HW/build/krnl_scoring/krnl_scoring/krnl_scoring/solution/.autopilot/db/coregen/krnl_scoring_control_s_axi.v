...
// ==============================================================
`timescale 1ns/1ps
module krnl_scoring_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER           = 7'h08,
    ADDR_ISR           = 7'h0c,
    ADDR_TYPE_R_DATA_0 = 7'h10,
    ADDR_TYPE_R_CTRL   = 7'h14,
    ADDR_IN1_DATA_0    = 7'h18,
    ADDR_IN1_DATA_1    = 7'h1c,
    ADDR_IN1_CTRL      = 7'h20,
    ADDR_IN2_DATA_0    = 7'h24,
    ADDR_IN2_DATA_1    = 7'h28,
    ADDR_IN2_CTRL      = 7'h2c,
    ADDR_OUT_R_DATA_0  = 7'h30,
    ADDR_OUT_R_DATA_1  = 7'h34,
    ADDR_OUT_R_CTRL    = 7'h38,
    ADDR_SIZE_DATA_0   = 7'h3c,
    ADDR_SIZE_CTRL     = 7'h40,
    WRIDLE             = 2'd0,
    WRDATA             = 2'd1,
    WRRESP             = 2'd2,
    WRRESET            = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_TYPE_R_DATA_0: begin
                    rdata <= int_type_r[31:0];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_TYPE_R_DATA_0)
            int_type_r[31:0] <= (WDATA[31:0] & wmask) | (int_type_r[31:0] & ~wmask);
    end
end
