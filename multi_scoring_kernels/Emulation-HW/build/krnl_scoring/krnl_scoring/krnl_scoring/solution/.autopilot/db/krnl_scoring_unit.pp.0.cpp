# 1 "/home/cnic/wz/workspace/multi_scoring_kernels/src/krnl_scoring_unit.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/cnic/wz/workspace/multi_scoring_kernels/src/krnl_scoring_unit.cpp" 2
...
# 2 "/home/cnic/wz/workspace/multi_scoring_kernels/src/krnl_scoring_unit.cpp" 2
...
# 3 "/home/cnic/wz/workspace/multi_scoring_kernels/src/krnl_scoring_unit.cpp" 2
...
using std::tgamma;
using std::trunc;
# 4 "/home/cnic/wz/workspace/multi_scoring_kernels/src/krnl_scoring_unit.cpp" 2
...
void scoring_product(hls::stream<float>& in1_stream, hls::stream<float>& in2_stream, hls::stream<float>& out_stream, int size) {
    VITIS_LOOP_15_1: for (int i = 0; i < size; i++) {
...
void scoring_cosine(hls::stream<float>& in1_stream, hls::stream<float>& in2_stream, hls::stream<float>& out_stream, int size) {
    ...
    float norm1 = 0.0;
    float norm2 = 0.0;
    VITIS_LOOP_24_1: for (int i = 0; i < size; i++) {
...
void scoring_euclidean(hls::stream<float>& in1_stream, hls::stream<float>& in2_stream, hls::stream<float>& out_stream, int size) {
    float sum = 0.0;
    VITIS_LOOP_36_1: for (int i = 0; i < size; i++) {
...
extern "C" {
__attribute__((sdx_kernel("krnl_scoring", 0))) void krnl_scoring(int type, float* in1, float* in2, float* out, int size) {
#line 27 "/home/cnic/wz/workspace/multi_scoring_kernels/Emulation-HW/build/krnl_scoring/krnl_scoring/krnl_scoring.tcl"
#pragma HLSDIRECTIVE TOP name=krnl_scoring
# 45 "/home/cnic/wz/workspace/multi_scoring_kernels/src/krnl_scoring_unit.cpp"
