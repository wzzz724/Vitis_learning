...
set hasInterrupt 0
set C_modelName {load_input.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 32 regular {axi_master 0}  }
	{ in_r int 64 regular  }
	{ size int 32 regular  }
	{ in2_stream int 32 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in2","offset": { "type": "dynamic","port_name": "in2","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "in2_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ in2_stream_din sc_out sc_lv 32 signal 3 } 
	{ in2_stream_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ in2_stream_fifo_cap sc_in sc_lv 2 signal 3 } 
	{ in2_stream_full_n sc_in sc_logic 1 signal 3 } 
	{ in2_stream_write sc_out sc_logic 1 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in2_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "in2_stream", "role": "din" }} , 
 	...
 	{ "name": "in2_stream_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in2_stream", "role": "full_n" }} , 
 	{ "name": "in2_stream_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in2_stream", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_load_input_1_Pipeline_mem_rd_fu_64", "Port" : "gmem1", "Inst_start_state" : "72", "Inst_end_state" : "73"}]},
			{"Name" : "in_r", "Type" : "None", "Direction" : "I"},
			{"Name" : "size", "Type" : "None", "Direction" : "I"},
			{"Name" : "in2_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_load_input_1_Pipeline_mem_rd_fu_64", "Port" : "in2_stream", "Inst_start_state" : "72", "Inst_end_state" : "73"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_load_input_1_Pipeline_mem_rd_fu_64", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_load_input_1_Pipeline_mem_rd_fu_64.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	in2_stream { ap_fifo {  { in2_stream_din fifo_port_we 1 32 }  { in2_stream_num_data_valid fifo_status_num_data_valid 0 2 }  { in2_stream_fifo_cap fifo_update 0 2 }  { in2_stream_full_n fifo_status 0 1 }  { in2_stream_write fifo_data 1 1 } } }
}
