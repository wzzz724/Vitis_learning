...
entity krnl_scoring_control_s_axi is
generic (
...
end entity krnl_scoring_control_s_axi;
...
architecture behave of krnl_scoring_control_s_axi is
    ...
    constant ADDR_TYPE_R_DATA_0 : INTEGER := 16#10#;
    constant ADDR_TYPE_R_CTRL   : INTEGER := 16#14#;
    constant ADDR_IN1_DATA_0    : INTEGER := 16#18#;
    constant ADDR_IN1_DATA_1    : INTEGER := 16#1c#;
    constant ADDR_IN1_CTRL      : INTEGER := 16#20#;
    constant ADDR_IN2_DATA_0    : INTEGER := 16#24#;
    constant ADDR_IN2_DATA_1    : INTEGER := 16#28#;
    constant ADDR_IN2_CTRL      : INTEGER := 16#2c#;
    constant ADDR_OUT_R_DATA_0  : INTEGER := 16#30#;
    constant ADDR_OUT_R_DATA_1  : INTEGER := 16#34#;
    constant ADDR_OUT_R_CTRL    : INTEGER := 16#38#;
    constant ADDR_SIZE_DATA_0   : INTEGER := 16#3c#;
    constant ADDR_SIZE_CTRL     : INTEGER := 16#40#;
    ...
    signal int_type_r          : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_TYPE_R_DATA_0 =>
                        rdata_data <= RESIZE(int_type_r(31 downto 0), 32);
...
-- ----------------------- Register logic ----------------
    ...
    type_r               <= STD_LOGIC_VECTOR(int_type_r);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_TYPE_R_DATA_0) then
                    int_type_r(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_type_r(31 downto 0));
                end if;
            end if;
        end if;
    end process;
