...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    krnl_scoring_hls_deadlock_detect_unit #(4, 0, 3, 3) krnl_scoring_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~entry_proc_U0.type_r_c_blk_n) | (~entry_proc_U0.out_r_c_blk_n);
    assign proc_0_data_PIPO_blk[0] = 1'b0;
    assign proc_0_start_FIFO_blk[0] = 1'b0 | (~start_for_Block_entry17_proc_U0_U.if_full_n & entry_proc_U0.ap_start & ~entry_proc_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_Block_entry17_proc_U0_U.if_read);
    ...
    krnl_scoring_hls_deadlock_detect_unit #(4, 1, 3, 3) krnl_scoring_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    krnl_scoring_hls_deadlock_detect_unit #(4, 2, 3, 3) krnl_scoring_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    // Process: Block_entry17_proc_U0
    krnl_scoring_hls_deadlock_detect_unit #(4, 3, 3, 3) krnl_scoring_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~Block_entry17_proc_U0.type_r_blk_n) | (~Block_entry17_proc_U0.out_r_blk_n);
    assign proc_3_data_PIPO_blk[0] = 1'b0;
    assign proc_3_start_FIFO_blk[0] = 1'b0 | (~start_for_Block_entry17_proc_U0_U.if_empty_n & Block_entry17_proc_U0.ap_idle & ~start_for_Block_entry17_proc_U0_U.if_write);
    assign proc_3_TLF_FIFO_blk[0] = 1'b0;
    assign proc_3_input_sync_blk[0] = 1'b0;
    assign proc_3_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_3[0] = dl_detect_out ? proc_dep_vld_vec_3_reg[0] : (proc_3_data_FIFO_blk[0] | proc_3_data_PIPO_blk[0] | proc_3_start_FIFO_blk[0] | proc_3_TLF_FIFO_blk[0] | proc_3_input_sync_blk[0] | proc_3_output_sync_blk[0]);
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~Block_entry17_proc_U0.size_blk_n) | (~Block_entry17_proc_U0.grp_scoring_cosine_fu_112.grp_scoring_cosine_Pipeline_VITIS_LOOP_24_1_fu_46.in1_stream_blk_n);
    ...
    assign proc_3_data_FIFO_blk[2] = 1'b0 | (~Block_entry17_proc_U0.grp_scoring_cosine_fu_112.grp_scoring_cosine_Pipeline_VITIS_LOOP_24_1_fu_46.in2_stream_blk_n);
...
`include "krnl_scoring_hls_deadlock_report_unit.vh"
